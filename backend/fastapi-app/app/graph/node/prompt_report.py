...
- 이번 대화의 **핵심만** 극도로 간결하게 한국어로 요약해 주세요 (존댓말).
- 반드시 **최대 50자 이내**로 작성하세요. 이는 엄격한 제한입니다. 50자를 초과하면 안 됩니다.
- 1-2개의 완전한 문장으로 작성하세요. 문장이 중간에 끊기면 안 됩니다.
- "{member_name}"님과 "{voice_name}" 간의 핵심 대화 주제만 포함하세요.
- 모든 세부 내용을 생략하고 가장 중요한 내용만 담으세요.
